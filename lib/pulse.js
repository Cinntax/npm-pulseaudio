...
Context.prototype.module = function(cb){
	this.$.info(PulseContext.info.module_list, infoListWrap(cb));
};

Context.prototype.loadmodule = function(module_name, argument_list, cb){
	console.log('calling C method...');
	this.$.loadmodule(module_name, argument_list, cb);
	console.log('call complete.');	
};

Context.prototype.unloadmodule = function(index, cb){
	console.log('calling c method...');
	this.$.unloadmodule(index, cb);
	console.log('call complete');
};

Context.prototype.set_source_volume_by_name = function(source_name, volume, cb){
	console.log('calling c method to set source volume to ' + volume);
	this.$.set_source_volume_by_name(source_name, volume, cb);
	console.log('call complete');
};
